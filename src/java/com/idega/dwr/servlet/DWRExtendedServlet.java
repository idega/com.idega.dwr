...
public class DWRExtendedServlet extends DwrServlet implements JarLoader {
	...
	private static final Logger LOGGER = Logger.getLogger(DWRExtendedServlet.class.getName());
	...
	public void loadJar(File bundleJarFile, JarFile jarFile, String jarPath) {
		...
		try {
			...
			LOGGER.log(Level.WARNING, "Error loading dwr.xml from " + jarFile.getName(), e);
		} finally {
